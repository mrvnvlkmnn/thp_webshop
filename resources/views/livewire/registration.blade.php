                    ...
                    <form wire:submit.prevent>
                        <div class="shadow overflow-hidden sm:rounded-md">
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <button wire:click="validateData" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-light hover:bg-yellow-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Save
                                </button>
                            </div>
                        </div>
