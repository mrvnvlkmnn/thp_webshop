        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="flex justify-between items-center md:justify-start md:space-x-10 pt-4">
                ...
                <nav class="hidden md:flex space-x-10">
                    @if(Request::path() == '/')
                        <a href="/"
                           class="text-base font-medium text-yellow-light hover:text-yellow-dark rounded border-b-4 border-yellow-light">
                            Home
                        </a>
                    @else
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    <a role="button" @click="cart = true"
                       class="bg-yellow-light rounded-full border-2 border-yellow-light py-1 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 svgChangeColor" fill="white"
                             viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
